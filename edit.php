...
<form class="col-md-6 offset-md-3" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="price" name="price" min="0" step="10" value="<?php echo $price;?>">
    </div>
    <div class="mb-3">
        <div class="container">
...
<div class="col-md-3 item-image">
    <div class="row">
                        ...
                        <div>
                    <img src="images/'.$img['name'].'" id="'.$img['id'].'_image" width="100%">
                    <input type="hidden" id="'.$img['id'].'_file" value="'.$img['name'].'" name="images[]">
                </div>
                </div>';
                }
                ?>
    ...
    <div class="mb-3">
        ...
        <textarea name="description" cols="30" rows="10" class="form-control" id="description"><?php echo $description;?></textarea>
    </div>
